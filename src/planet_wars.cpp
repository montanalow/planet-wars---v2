...
planet::planet(int planet_id, double x, double y, int owner, int num_ships, int growth_rate) {
...
void planet_wars::issue_order(int source_planet, int destination_planet, int num_ships) const {
